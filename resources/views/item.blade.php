                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="text-xs text-gray-500">Ditambah: {{ $item->created_at->format('d/m/Y') }}
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                         ...
                         <span
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex space-x-2">
                                                ...
                                                <button
                                                    class="delete-barang-btn text-red-600 hover:text-red-900 transition duration-200 p-2 rounded hover:bg-red-50"
                                                    data-id="{{ $item->id }}" data-name="{{ $item->name }}"
                                                    data-code="{{ $item->item_code }}" title="Hapus">
